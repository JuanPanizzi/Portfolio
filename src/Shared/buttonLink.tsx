...
export const ButtonLink = ({title, url}: ButtonProps) => {
  ...
  return (
    ...
    <a href={url} className='lg:text-[1rem] lg:px-3 lg:py-[7px] px-1 text-white py-[1px] inline-block flex items-center border border-white rounded-full flex  text-[0.5rem]  mr-1 transition  hover:border-green-1 hover:text-green-1 md:text-xs md:px-2 md:py-1 md:mt-2 '
    target='_blank'
        > 
