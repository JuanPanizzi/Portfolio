...
{/*
  ...
  Plugins:
    - @tailwindcss/forms
*/}
<h1 className='text-white text-center mt-28 mb-4 font-medium' id='contacto'>¡Contactame!</h1>
<section className=''>
  ...
  method="POST" className="space-y-4">
          ...
          <div className="mt-4">
            <button
              type="submit"
              className="inline-block w-full rounded-xl bg-black-btn border hover:border-1 hover:text-green-1 hover:border-green-1 px-5 py-3 font-medium text-white sm:w-auto"
            >
              Enviar
            </button>
          </div>
